...
class SmsMessage(db.Model):
    ...
    Modelo para armazenar histórico de mensagens SMS
    """
    ...
    def to_dict(self):
        ...
        Converte modelo para dicionário para serialização JSON
        """
        return {
            'id': self.id,
...
class Contact(db.Model):
    ...
    Modelo para armazenar contatos (clientes e funcionários)
    """
    id = db.Column(db.Integer, primary_key=True)
    ...
    # Relationship with groups / Relacionamento com grupos
...
class ContactGroup(db.Model):
    ...
    Modelo para armazenar grupos de contatos
    """
    id = db.Column(db.Integer, primary_key=True)
    name = db.Column(db.String(100), nullable=False)
    ...
    # Relationship with contacts / Relacionamento com contatos
...
# Tabela de associação para relacionamento muitos-para-muitos entre contatos e grupos
...
class SmsTemplate(db.Model):
    ...
    Modelo para armazenar templates de SMS
    """
    id = db.Column(db.Integer, primary_key=True)
    name = db.Column(db.String(100), nullable=False)
